...
from conf.settings_custom import *  # noqa
...
APP_ID = 'guo-test-job'
APP_TOKEN = 'c12d848f-42b3-4729-b271-4acae49083ba'
BK_PAAS_HOST = 'http://paas.bktest.cntv.net'
...
BROKER_URL_DEV = 'redis://127.0.0.1:6379/'
...
INSTALLED_APPS += locals()['INSTALLED_APPS_CUSTOM']
MIDDLEWARE_CLASSES += locals()['MIDDLEWARE_CLASSES_CUSTOM']
...
if IS_USE_CELERY:
    try:
        ...
        if RUN_MODE == 'DEVELOP':
            ...
            @worker_process_init.connect  # noqa
